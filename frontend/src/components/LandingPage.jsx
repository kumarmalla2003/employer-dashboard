  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-950 text-gray-200">
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex items-center justify-between">
          ...
          <Link
            ...
            className="sm:hidden flex items-center space-x-3 text-3xl font-bold text-blue-500 hover:text-blue-400 transition-colors"
          >
            {/* The span below will be hidden on mobile (xs) screens and visible on sm and larger */}
            <span className="inline">Employd</span>
          </Link>
      ...
      <main className="flex-grow pt-24">
        {/*
          New container to ensure consistent padding and max-width across all sections
          This replaces the individual 'container mx-auto px-4' classes on each section
        */}
